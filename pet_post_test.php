                        ...
                        <div class="row">
                            ...
                            <div id="medical_history"style="display: none;">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="form-field">
                                            <input type="text" name="pet_medical[]" class="form-control" placeholder="病史">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <button type="button" onclick="addMedicalHistoryField()" class="btn btn-primary">＋</button>
                                    </div>
                                </div>
                            </div>
                            <script>
                                ...
                                function addMedicalHistoryField() {
                                    ...
                                    newInput.className = "col-md-9 form-group form-control";
                                    newInput.style = "margin-left:11px;"
                                    medicalHistoryContainer.appendChild(newInput);
                                }
